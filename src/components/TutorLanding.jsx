            ...
            <section className="relative w-full min-h-screen overflow-hidden text-white">
                ...
                <div className="relative mx-auto w-full max-w-7xl px-6 pt-16 pb-28">
                    ...
                    <p className="text-center text-[#FFD700] tracking-[0.12em] mb-3 text-[16px] md:text-[18px] font-light">
                        Empower students with your expertise and passion for teaching.
                    </p>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-[2fr_auto_1fr] items-center gap-10 lg:gap-16">
                            ...
                            <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md shadow-2xl p-7 md:p-8 max-w-7xl mx-auto lg:mx-0 lg:mr-[-350px] z-10">
                                <p className="text-white/90 leading-relaxed text-left">
                                    Join our network of expert tutors and help students master mathematics through personalized guidance and innovative teaching methods.
                                </p>
                            ...
                            <div className="max-w-md mx-auto lg:mx-0 lg:ml-[-300px] z-20">
                                <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md shadow-2xl p-7 md:p-8 mb-6">
                                    <p className="text-white/90 leading-relaxed">
                                        Access comprehensive teaching resources and tools to enhance your tutoring experience.
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-6 ml-8">
                                    <div>
                                        <p className="text-[#FFD700] text-3xl font-bold mb-1">500+</p>
                                    ...
                                    <div>
                                        <p className="text-[#FFD700] text-3xl font-bold mb-1">95%</p>
            ...
            <section className="relative w-full py-20 bg-[#011810] text-white">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-white/30 hover:bg-white/15">
                            <div className="w-16 h-16 flex items-center justify-center mb-6 mx-auto">
                                <img src="/images/1.png" alt="Teaching Resources" className="w-10 h-10 object-contain" />
                            </div>
                            <h3 className="text-xl font-bold mb-4 text-center">Teaching Resources</h3>
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-white/30 hover:bg-white/15">
                            <div className="w-16 h-16 flex items-center justify-center mb-6 mx-auto">
                                <img src="/images/Video.png" alt="Video Creation" className="w-10 h-10 object-contain" />
                            </div>
                            <h3 className="text-xl font-bold mb-4 text-center">Video Creation</h3>
                            <p className="text-white/80 leading-relaxed text-center mt-5">
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-white/30 hover:bg-white/15">
                            <div className="w-16 h-16 flex items-center justify-center mb-6 mx-auto">
                                <img src="/images/Progress.png" alt="Student Analytics" className="w-10 h-10 object-contain" />
                            </div>
                            <h3 className="text-xl font-bold mb-4 text-center">Student Analytics</h3>
                            <p className="text-white/80 leading-relaxed text-center mt-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-4xl mx-auto">
                        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-white/30 hover:bg-white/15">
                            <div className="w-16 h-16 flex items-center justify-center mb-6 mx-auto">
                                <img src="/images/247access.png" alt="Flexible Schedule" className="w-10 h-10 object-contain" />
                            </div>
                            <h3 className="text-xl font-bold mb-4 text-center">Flexible Schedule</h3>
                            <p className="text-white/80 leading-relaxed text-center mt-5">
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-white/30 hover:bg-white/15">
                            <div className="w-16 h-16 flex items-center justify-center mb-6 mx-auto">
                                <img src="/images/Community.png" alt="Tutor Community" className="w-10 h-10 object-contain" />
                            </div>
                            <h3 className="text-xl font-bold mb-4 text-center">Tutor Community</h3>
                            <p className="text-white/80 leading-relaxed text-center mt-5">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-base md:text-lg lg:text-xl text-white/80 max-w-2xl mx-auto px-4">
                            Choose the tutoring plan that fits your expertise and availability.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
                        ...
                        <div className="bg-[#002317] rounded-xl border border-white/20 p-6 shadow-lg text-center">
                            ...
                            <div className="space-y-3 mb-8">
                                <div className="flex items-center">
                                    ...
                                    <span className="text-white text-sm">Up to 10 hours/week</span>
                                </div>
                                <div className="flex items-center">
                                    <span className="text-[#00FF11] mr-3">✓</span>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="text-white/60 text-sm">Priority scheduling</span>
                                </div>
                                <div className="flex items-center">
                                    <span className="text-gray-400 mr-3">✗</span>
                            ...
                            <p className="text-center text-white/50 text-xs">Flexible commitment</p>
                        </div>
                        ...
                        <div className="bg-white/5 backdrop-blur-md rounded-xl border border-white/20 p-6 shadow-lg text-center">
                            ...
                            <p className="text-[#00FF11] text-sm mb-4">Professional tutoring career</p>
                            <div className="mb-6">
                            ...
                            <div className="space-y-3 mb-8">
                                ...
                                <div className="flex items-center">
                                    <span className="text-[#00FF11] mr-3">✓</span>
                                    <span className="text-white text-sm">Priority scheduling</span>
                                </div>
                                <div className="flex items-center">
                                    <span className="text-[#00FF11] mr-3">✓</span>
                                    <span className="text-white text-sm">Performance bonuses</span>
                                </div>
                            </div>
                            ...
                            <p className="text-center text-white/50 text-xs">Professional path</p>
                        </div>
                        ...
                        <div className="bg-[#002317] rounded-xl border border-white/20 p-6 shadow-lg text-center">
                            ...
                            <div className="space-y-3 mb-8">
                                ...
                                <div className="flex items-center">
                                    <span className="text-[#00FF11] mr-3">✓</span>
                                    <span className="text-white text-sm">Leadership opportunities</span>
                                </div>
                            </div>
            ...
            <footer className="bg-[#010f0a] text-white">
                <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12">
                    ...
                    <div className="space-y-4 text-center md:text-left">
                        ...
                        <a href="#" className="block text-white/90 text-lg md:text-xl hover:text-yellow-400">Tutoring</a>
                        <a href="#" className="block text-white/90 text-base md:text-lg hover:text-yellow-400">Resources</a>
                        <a href="#" className="block text-white/90 text-lg md:text-xl hover:text-yellow-400">Support</a>
                    </div>
                    ...
                    <div className="space-y-4 text-center md:text-left">
                        ...
                        <p className="text-white/80 text-lg md:text-xl">tutors@mathmentor.com</p>
                    </div>
                </div>
